Daikin-Control-Angular
======================
This is a fork from the [daikin-control](https://github.com/ael-code/daikin-control) library. This fork mainly focuses on Angular 2+ development and also features a Node.js backend besides the original PHP backend.
